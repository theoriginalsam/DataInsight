    ...
    <>
      ...
      <div>
        <a
          ...
          className="flex flex-col items-center  bg-white justify-center m-2 p-6 rounded- bg-gray-50 shadow-lg transition-transform duration-300 hover:scale-105"
        >
          <div>
            <h1 className="text-3xl font-bold bo text-black mb-4">
      ...
      <section
        id="features"
        className="flex py-40 pb-40 bg-primary text-white "
      >
        <div className="grid grid-cols-1 gap-x-8 gap-y-14 px-6 md:grid-cols-2 lg:grid-cols-2">
