...
const EnrollToday = () => {
  return (
    <div className="flex flex-col items-left bg-primary justify-center m-6 p-6 border-3 border-gray-300 rounded-lg bg-gray-50 shadow-lg transition-transform duration-300 hover:scale-105">
