// import { Feature } from "../types/chapters";
...
//     paragraph: "Learn what a computer really is and how it works.",
//   },
//   {
//     id: 2,
//     icon: "path/to/your/image2.jpg", // Replace with your actual image path or URL
//     title: "Express Computer Programming",
//     paragraph: "Dive into the world of programming with fun projects that teach the fundamentals of coding using visual programming languages.",
//   },
//   {
//     id: 3,
//     icon: "path/to/your/image3.jpg", // Replace with your actual image path or URL
//     title: "Web Development",
//     paragraph: "Discover the basics of web development and learn to create your own websites using HTML, CSS, and JavaScript",
//   },
//   {
//     id: 4,
//     image: "path/to/your/image4.jpg", // Replace with your actual image path or URL
//     title: "AI and Machine Learning",
//     paragraph: "Explore the exciting field of artificial intelligence and machine learning with age-appropriate projects and experiments.",
//   }
// ];
...
const featuresData: Feature[] = [
  {
    ...
    title: "Introduction to Computers",
    paragraph:
      "Learn the basics of computers, including hardware, software, and essential operations in a fun and interactive way",
  },
  {
    id: 2,
    icon: (
    ...
    title: "Express Computer Programming",
    paragraph:
      "Dive into the world of programming with fun projects that teach the fundamentals of coding using visual programming languages.",
  },
  {
    id: 3,
    icon: (
