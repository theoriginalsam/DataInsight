...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp bg-primary dark:bg-gray-dark relative z-10 text-white pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
        <div className="mx-10 ">
              ...
              <div className=" max-w-[360px] ">
                ...
                <div className="flex items-center mb-9">
                  <a
                    ...
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-secondary dark:hover:text-secondary"
                  >
                    <svg
                      width="9"
                      height="18"
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="/blogs"
                      className="dark:text-body-color-dark mb-4  inline-block text-base text-body-color duration-300 hover:text-secondary dark:hover:text-secondary"
                    >
                      Blog
                    </a>
                  </li>
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="/contact"
                      className="dark:text-body-color-dark mb-4 inline-block text-base text-body-color duration-300 h hover:text-secondary dark:h hover:text-secondary"
                    >
                      Open Support Ticket
                    </a>
                  </li>
