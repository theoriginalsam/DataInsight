          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                <nav
                  id="navbarCollapse"
                  className={`navbar absolute right-0 z-30 w-[250px] rounded border-[.5px] border-body-color/50 bg-transparent px-6 py-4 duration-300 dark:border-body-color/20 dark:bg-dark lg:visible lg:static lg:w-auto lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 text-white ${
                    navbarOpen
                          ...
                          <>
                            ...
                            >
                              {menuItem.submenu?.map((submenuItem, index) => (
                                // Check if submenuItem.path is defined before using it
                                <React.Fragment key={index}>
                                  {submenuItem.path && (
                                    <>
                                      <Link
                                        href={submenuItem.path as string} // Assuming submenuItem.path is string | undefined
                                        // Add your className and other attributes here
                                      >
                                        {submenuItem.title}
                                      </Link>
